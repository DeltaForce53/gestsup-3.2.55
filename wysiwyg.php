...
<script type="text/javascript">
	...
	function loadVal(){
		...
		if($_GET['subpage']=='parameters' && $rright['admin'] && $_GET['tab']=='general')
		{
			echo '
			text = $("#editor").html();
		...
		if($_GET['subpage']=='parameters' && $rright['admin'] && $_GET['tab']=='plugin')
		{
			echo '
			text = $("#editor").html();
			document.plugin_form.text.value = text;
			text2 = $("#editor2").html();
			document.plugin_form.text2.value = text2;
			text3 = $("#editor3").html();
			document.plugin_form.text3.value = text3;
			';
		}
		?>
	}
