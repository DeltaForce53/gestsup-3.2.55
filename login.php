...
if($_POST['submit'])
{
	...
	{	
		...
		//mfa
		if($rparameters['user_mfa'])
		{
			require('core/mfa.php');
		}
...
if(!$_SESSION['login']) 
{
	...
	if($rparameters['mail_link_redirect_url'] && $_GET['page']=='ticket' && $_GET['id'])
	{
		...
		{
			echo '<div class="body-container" style=" background:url(upload/login_background/'.$rparameters['login_background'].') no-repeat fixed center; background-size: cover;" >	';
		} else {
		...
		echo '
			<div class="main-container container bgc-transparent">
				<div role="main" class="main-content">
					...
					<div class="p-4 p-md-4 mh-2 '; if($rparameters['azure_ad_sso_hide_login'] && !$_GET['local_auth']) {echo 'd-none';} echo '">
