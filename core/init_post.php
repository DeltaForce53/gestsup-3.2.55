...
foreach($all_numeric_var as $numeric_var) {
	if(
		$_POST[$numeric_var] && 
		!is_numeric($_POST[$numeric_var]) &&
		$_POST[$numeric_var]!='%' &&
		$_POST[$numeric_var]!='all' &&
		$_POST[$numeric_var]!='meta'
	) {  echo 'ERROR : incorrect value on $_POST['.$numeric_var.']'; exit;}
}
...
if(!in_array($_POST['dashboard_ticket_order'],$order_white_list)) {$_POST['dashboard_ticket_order']='id';} 
