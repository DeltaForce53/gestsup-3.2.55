...
<br />
<u>Update :</u><br />
- Améliorations de compatibilité PHP 8.4 </br />
- Liste des tickets : nouveau droit "dashboard_col_technician" pour régler l'affichage de la colonne technicien (./dashboard.php)<br />
- États : nouveau paramètre dans l'administration de la liste des états pour masquer certains états (./dashboard.php)<br />
- Onglet : nouveau paramètre d'affichage général, afin de personnaliser le nom de l'onglet dans le navigateur (./admin/parameters)<br />
- Mail : ajout de tags (./template/mail) <br />  
- Composant : webklex/php-imap v6.1.0 (./vendor/webklex/*)<br />
- Composant : Oauth2-client v2.8.1(./vendor/league/oauth-client/*)<br />
- Composant : Highcharts v12.1.2 (./vendor/components/Highcharts/*)<br />
- Composant : Font-Awesome v6.7.2 (/vendor/FortAwesome/Font-Awesome<br />
- Composant : PHPMailer v6.9.3 (./vendor/phpmailer/*)<br />
<u>Bugfix :</u><br />
- Liste tickets : erreur sur la vue de groupe (./dashboard.php) <br />   
<br />
#################################<br />
# @Name : GestSup Release Notes  <br />
# @Date : 22/11/2024             <br />
...
<br />
<u>Notice :</u><br />
- PHP : version 8.1 minimum<br />
<u>Update :</u><br />
- Équipement : possibilité de préciser le prénom et le nom de l'utilisateur sur l'import (./core/import_assets.php)<br />
- Composant : PHPMailer v6.9.2 (./vendor/phpmailer/*)<br />
- Composant : oauth2-azure-provider v2.0.0 (./vendor/greew/*)<br />
- Composant : Font-Awesome v5.9.0 (/vendor/FortAwesome/Font-Awesome<br />
- Composant : Highcharts v12.0.1 (./vendor/components/Highcharts/*)<br />
- Sécurité : amélioration<br />
<u>Bugfix :</u><br />
- Ticket : page blanche lors de l'enregistrement avec des caractères spéciaux(./dashboard.php) <br />   
- Liste des tickets : erreur sur le filtre technicien, au niveau des groupes (./dashboard.php) <br />   
- Administration : erreur dans certains cas lors de suppression de tenant sur le connecteur Entra ID(./admin/parameters/connector.php) <br />   
- Login : dans certains cas erreur avec captcha (./index.php) <br />   
<br />
#################################<br />
# @Name : GestSup Release Notes  <br />
# @Date : 07/10/2024             <br />
...
<br />
<u>Update :</u><br />
- Ticket : possibilité de filtrer les catégories en fonction d'un type de ticket cf paramètre "Filtre de la catégorie en fonction d'un type"  (./ticket.php)<br />
- Login : plus d'affichage de la mire de connexion lors de l'utilisation de l'option "Masquer la page d'authentification GestSup" (./login.php)<br />
- Validation demandeur : ajout de logs (./core/user_validation.php)<br />
- Améliorations de sécurité<br />
- Améliorations de la mise en forme des mails automatiques à destination des technicien (./core/mail.php)<br />
<u>Bugfix :</u><br />
- Mail : Les tags mail #ticket_last_comment*, intégrait les messages privés (./core/mail.php) <br />  
- PLugins : Erreur de désinstallation de certains plugins (SQL) <br />  
<br />
#################################<br />
# @Name : GestSup Release Notes  <br />
# @Date : 05/09/2024             <br />
...
<br />
<u>Update :</u><br />
- Login : gestion de la connexion multi-facteurs cf paramètres généraux utilisateur (./mfa.php)<br />
- Login : erreur d'affichage de certaine images sur le fond d'écran de la page de connexion (./login.php)<br />
- Connecteurs : sur le connecteur imap, il est possible de sélectionner un dossier de messagerie nommé gestsup (./admin/parameters/connector.php)<br />
- Connecteurs : sur le connecteur entra le test valide aussi le formulaire (./admin/parameters/connector.php)<br />
- Administration : sur la liste des sociétés affichage des utilisateurs associés   (./admin/lists/edit.php)<br />
- Composant : FullCalendar v6.1.15 (./vendor/components/fullcalendar/*)<br />
- Composant : Highcharts v11.4.8 (./vendor/components/Highcharts/*)<br />
- Composant : Fontawesome v6.6.0 (./vendor/FortAwesome/Font-Awesome*)<br />
<u>Bugfix :</u><br />
- ticket : dans certains cas, erreur de prise en compte du temps passé sur le premier enregistrement du ticket (./userbar.php) <br />  
- Connecteur : dans certains cas erreur de connexion SSO avec Entra ID et MFA (./azure_ad_auth.php) <br />  
<br />
#################################<br />
# @Name : GestSup Release Notes  <br />
# @Date : 04/06/2024             <br />
...
<br />
<u>Update :</u><br />
- Connecteur : sur le connecteur Entra ID il est possible de supprimer des tenants de manière unitaire (./admin/parameters/)<br />
- Composant : Highcharts v11.4.3 (./vendor/components/Highcharts/*)<br />
- Composant : FullCalendar v6.1.13 (./vendor/components/fullcalendar/*)<br />
<u>Bugfix :</u><br />
- Liste des tickets : erreur de tickets pour les superviseurs dans certains cas (./userbar.php) <br />  
- Connecteur IMAP : dans certains cas erreur envoi de mail (./core/mail.php) <br />  
<br />
#################################<br />
# @Name : GestSup Release Notes  <br />
# @Date : 14/05/2024             <br />
