...
{
	//csrf check
	if(strtoupper($_SERVER['REQUEST_METHOD']=='POST') && $_POST['csrf_token'] != $_SESSION['csrf_token']) {die(DisplayMessage('error',T_('Token CSRF invalide')));}
                    										...
                    										<div>';
                    										    ...
                    										    echo '
                        										    ...
                        										    <select style="width:auto; max-width:235px;" class="form-control form-control-sm d-inline-block" name="dashboard_ticket_order" id="dashboard_ticket_order">
                        										        <option '; if($user1['dashboard_ticket_order']==''){echo "selected";} echo ' value="">'.T_("Aucun (Géré par l'administrateur)").'</option>
